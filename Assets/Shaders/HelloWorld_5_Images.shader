Shader "Unlit/HelloWorld_5_Images"
{
	Properties
	{
		...
		SubShader
	{
		...
		Pass
		{
			...
			const int nFrames = 5;				// Five frame support only
			const float TimeDuration = 22.0;
			...
			{
				vec2[nFrames] frames = vec2[nFrames](vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0));
			...
			vec2[nFrames] GetFrameTimes()
			{
				...
				vec2 timeFrames[nFrames] = vec2[nFrames](vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0), vec2(0.0));
				for (int i = 0; i < nFrames; i++)
			...
			{
				return vec2[nFrames](vec2(1.77489177 / VideoRes, 1.0), vec2(2.628205128205128 / VideoRes, 1.0), vec2(1.77777778 / VideoRes, 1.0), vec2(0.9259259259259259 / VideoRes, 1.0), vec2(1.0 / VideoRes, 1.0));
			}
			...
			void main()
			{
				...
				float fInit = Blending(timeFrames[1].x, timeFrames[1].y, -0.2) + 
								Blending(timeFrames[2].x, timeFrames[2].y, -0.4) + 
								Blending(timeFrames[3].x, timeFrames[3].y, -0.6) + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				//1
				frames[0].x += fInit;
				frames[0].y += Blending(timeFrames[0].x, timeFrames[0].y, 1.0 - frames[0].y) + fInit;

				offset += Blending(timeFrames[0].x, timeFrames[0].y, -offset) + 
							Blending(timeFrames[1].x, timeFrames[1].y, 0.2) + 
							Blending(timeFrames[2].x, timeFrames[2].y, 0.4) + 
							Blending(timeFrames[3].x, timeFrames[3].y, 0.6) + 
							Blending(timeFrames[4].x, timeFrames[4].y, 0.8);
				finalColor += TextureColor(_MainTex, UVs[0]*Blending(timeFrames[0], 1.0, fScale), vec2(offset, 0.0), frames[0]);
				
				float fFirst = Blending(timeFrames[0].x, timeFrames[0].y, 0.8);
				//2
				frames[1].x += Blending(timeFrames[1].x, timeFrames[1].y, -frames[1].x) + 
								fFirst + 
								Blending(timeFrames[2].x, timeFrames[2].y, -0.4) + 
								Blending(timeFrames[3].x, timeFrames[3].y, -0.6) + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				frames[1].y += Blending(timeFrames[1].x, timeFrames[1].y, 1.0-frames[1].y) + 
								fFirst + 
								Blending(timeFrames[2].x, timeFrames[2].y, -0.4) + 
								Blending(timeFrames[3].x, timeFrames[3].y, -0.6) + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				...
				offset -= 0.2;
				offset += Blending(timeFrames[1].x, timeFrames[1].y, -offset) + 
								Blending(timeFrames[0].x, timeFrames[0].y, -0.4);
				finalColor += TextureColor(_SecTex, UVs[1] * Blending(timeFrames[1], 1.0, fScale), vec2(offset, 0.0), frames[1]);
				
				//3
				frames[2].x += Blending(timeFrames[2].x, timeFrames[2].y, -frames[2].x) + 
								Blending(timeFrames[1].x, timeFrames[1].y, 0.6) + 
								fFirst + 
								Blending(timeFrames[3].x, timeFrames[3].y, -0.6) + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				frames[2].y += Blending(timeFrames[2].x, timeFrames[2].y, 1.0-frames[2].y) + 
								Blending(timeFrames[1].x, timeFrames[1].y, 0.6) + 
								fFirst + 
								Blending(timeFrames[3].x, timeFrames[3].y, -0.6) + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				...
				offset -= 0.2;
				offset += Blending(timeFrames[2].x, timeFrames[2].y, -offset) + 
							Blending(timeFrames[1].x, timeFrames[1].y, -0.4);
				finalColor += TextureColor(_ThirdTex, UVs[2] * Blending(timeFrames[2], 1.0, fScale), vec2(offset, 0.0), frames[2]);
				
				//4
				frames[3].x += Blending(timeFrames[3].x, timeFrames[3].y, -frames[3].x) + 
								Blending(timeFrames[2].x, timeFrames[2].y, 0.4) + 
								Blending(timeFrames[1].x, timeFrames[1].y, 0.6) + 
								fFirst + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				frames[3].y += Blending(timeFrames[3].x, timeFrames[3].y, 1.0-frames[3].y) + 
								Blending(timeFrames[2].x, timeFrames[2].y, 0.4) + 
								Blending(timeFrames[1].x, timeFrames[1].y, 0.6) + 
								fFirst + 
								Blending(timeFrames[4].x, timeFrames[4].y, -0.8);
				...
				offset -= 0.2;
				offset += Blending(timeFrames[3].x, timeFrames[3].y, -offset) + 
							Blending(timeFrames[2].x, timeFrames[2].y, -0.4);
				finalColor += TextureColor(_ForthTex, UVs[3] * Blending(timeFrames[3], 1.0, fScale), vec2(offset, 0.0), frames[3]);
				
				//5
				frames[4].x += Blending(timeFrames[4].x, timeFrames[4].y, -frames[4].x) + 
								Blending(timeFrames[3].x, timeFrames[3].y, 0.2) + 
								Blending(timeFrames[2].x, timeFrames[2].y, 0.4) + 
								Blending(timeFrames[1].x, timeFrames[1].y, 0.6) + 
								fFirst;
				frames[4].y += Blending(timeFrames[3].x, timeFrames[3].y, 0.2) + 
								Blending(timeFrames[2].x, timeFrames[2].y, 0.4) + 
								Blending(timeFrames[1].x, timeFrames[1].y, 0.6) + 
								fFirst;

				offset -= 0.2;
				offset += Blending(timeFrames[4].x, timeFrames[4].y, -offset) + 
							Blending(timeFrames[3].x, timeFrames[3].y, -0.4);
				finalColor += TextureColor(_FifthTex, UVs[4] * Blending(timeFrames[4], 1.0, fScale), vec2(offset, 0.0), frames[4]);
